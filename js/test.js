// ============================================
// TEST.JS - 20 SAVOL, 35 DAKIKA, QIYINLIK KOEFFITSIENTI
// ============================================

// QIYINLIK_KOEFF ni faqat agar mavjud bo'lmasa e'lon qilamiz
...
// Sinf tanlash (global funksiya)
window.selectTestClass = async function(classNum) {
  console.log("Sinf tanlandi:", classNum);
...
// Fanni tanlash (global funksiya)
window.selectSubject = function(subjectId) {
  console.log("Fan tanlandi:", subjectId);
...
// Orqaga qaytish (global funksiya)
...
// Student ma'lumotlarini yuborish (global funksiya)
window.submitStudentInfo = async function(event) {
...
// Javobni tanlash (global funksiya)
...
// Testni tugatish (global funksiya)
...
// Qayta boshlash (global funksiya)
...
// Test tanlashga qaytish (global funksiya)
...
// Batafsil natijalar (global funksiya)
